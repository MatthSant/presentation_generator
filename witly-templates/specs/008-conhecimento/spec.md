...
**Estado**: desenho fechado em 2026-09-12; fases 1–2 (banco + MCP) no PR #68 e fases 3 (UI), 4 (`kind = conversa`) e 5 (campanha e ações) nos PRs seguintes — ver `tasks.md` e `evidencias*.md`. A spec está implementada.
