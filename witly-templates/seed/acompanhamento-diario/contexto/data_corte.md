...
**Saída:** `config.data_corte` (AAAA-MM-DD), `config.data_report` (AAAA-MM-DD). Não precisa confirmar se a regra abaixo resolver.
...
3. Se o consultor pedir um corte específico ("fecha em 05/09"), use o dele.
