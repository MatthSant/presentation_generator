...
- **Volume e qualificação** (8 kpi-cards): Investimento total, Leads totais, Vendas (produto principal), Reembolsos, Leads recapturados, Qualificação (MQL), Conversão MQL, Split pago × orgânico.
