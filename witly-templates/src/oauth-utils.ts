...
export function renderApprovalDialog(request: Request, options: ApprovalDialogOptions): Response {
    ...
    <html lang="en">
      <head>
        ...
        <title>${clientName} | Autorização</title>
        <style>
          :root {
      ...
      <body>
        <div class="container">
          ...
          <div class="card">
            ...
            <p>Este cliente MCP pede autorização para usar ${serverName}. Ao aprovar, você será levado ao login Google da Witly.</p>
            ...
            <form method="post" action="${new URL(request.url).pathname}">
              ...
              <div class="actions">
                <button type="button" class="button button-secondary" onclick="window.history.back()">Cancelar</button>
